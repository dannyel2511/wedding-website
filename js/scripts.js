$(document).ready(function () {
    ...
    /***************** Waypoints ******************/
    $('.wpParents1').waypoint(function () {
        $('.wpParents1').addClass('animated fadeInLeft');
    }, {
        offset: '75%'
    });
    $('.wpParents2').waypoint(function () {
        $('.wpParents2').addClass('animated fadeInRight');
    }, {
        offset: '75%'
    });
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== '3b712de48137572f3849aabd5666a4e3'
            ...
            $.post('https://script.google.com/macros/s/AKfycbz28zIvgATXxUv_fq-cqB9Os0R0kjOtSvWn6-HnEgjAwtmxaizNADpKQvN7I_rq0G2x/exec', data)
                .done(function (data) {
                    console.log(data);
                ...
                .fail(function (data) {
                    console.log(data);
                    $('#alert-wrapper').html(alert_markup('danger', '<strong>Disculpa!</strong> Hubo un problema. Vuelve a intentar. '));
                });
        }
    });
...
// Google map
function initMap() {
    var location = {lat: 20.630247418238323, lng: -100.35369531166965};
...
function initBBSRMap() {
    var la_fiesta = {lat: 20.630247418238323, lng: -100.35369531166965};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
